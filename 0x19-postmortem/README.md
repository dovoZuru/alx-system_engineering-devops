...
Imagine an outage occurred on an isolated Ubuntu 14.04 container running an Apache web server. GET requests on the server led to
...
https://uptimerobot.com to alert instantly upon outage of the website.

This error will never occur again, because we're programmers, and we never make
errors! :wink:
